...
export const journeyEras: JourneyEra[] = [
  ...
  },
  {
    ...
    title: 'Enterprise Technical Leadership (SS&C Healthcare Adjudication)',
    period: '2021 — 2024',
    description: 'Led core engineering and technical architecture for SS&C DomaniRx pharmacy claims adjudication, modernizing legacy COBOL adjudication engines into ultra-low-latency Java 21 / Spring Boot 3 microservices processing ~600M annual claims. Spearheaded B1/B2/B3 transaction processing, real-time accumulator deductions, and proprietary clinical safety modules under strict CMS Medicare Part D mandates.',
